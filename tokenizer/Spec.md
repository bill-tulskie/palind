...
The tokenizer takes as input a set of fields with personal information about the patient:
...
The same is applied to `email` field, which is validated against the [RFC 3696](https://tools.ietf.org/html/rfc3696) specification.
